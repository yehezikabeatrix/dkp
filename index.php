                            ...
                            <?php foreach ($contacts as $contact) : ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a type="button" class="btn btn-sm btn-outline btn-danger" href="delete.php?id=<?= $contact['id'] ?>" class="trash" onclick="return confirm('Are you sure to delete this item?');">delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
